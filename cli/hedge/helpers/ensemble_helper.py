...
def save_ensemble_results(ensemble_proba: np.ndarray, ensemble_pred: np.ndarray, y_test: np.ndarray, 
    ...
    # Calculate metrics
    metrics = evaluate_classification(y_test, ensemble_pred, class_names, metric='weighted')
...
def evaluate_single_model(model, model_type: str, X_test: np.ndarray, y_test: np.ndarray, 
    ...
    # Calculate metrics
    metrics = evaluate_classification(y_test, y_pred_idx, class_names, metric='weighted')
